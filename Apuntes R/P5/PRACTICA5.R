...
# Transforma los datos para que visualmente se vean mejor y sean comparables o uniformes, 
# para los análisis se utilizan los datos brutos.
data2 = log2(data)
...
# Los bigotes son la variación, la caja representa la media y los cuartiles y los puntos fuera de 
# los bigotes son los valores atípicos.
# Hemos realizado el boxplot con la data2, el col son los colores usados, el main es el título del 
# gráfico y las=2 es para que el gráfico salga vertical.
# ¿Qué es un boxplot?
# Es una representación gráfica de una serie de datos distribuidos por cuartiles.
...
# La separación es correcta porque los ratones WT están agrupados juntos y los KO también.
...
# Hemos generado dos tablas donde hemos cogido las 3 primeras columnas de nuestra data principal,
# y la hemos llamado wt y la segunda tabla ko con las columnas de la 4 a la 6.
wt <- data[,1:3]
ko <- data[,4:6]
class(wt)
head(wt)
...
# Para análisis de datos hay que usar los datos brutos.
# ¿Cuántas valores tiene cada muestra?
# Cada muestra tiene 12488 genes.
pvalue = NULL 
tstat = NULL 
...
# Hace los valores más pequeños para facilitar su interpretación.
...
# 426 genes son los que cumplen los dos criterios.
...
# Los sobreexpresados salen en el lado negativo y los reprimidos en el lado positivo,
# esto resulta de la media cuando hemos restado los WT - KO.
