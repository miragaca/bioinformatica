...
rep(1,10) #repite el nº1, 10 veces


seq(2,6) #de donde empieza a donde acaba


seq(4,20,by=4) #el by es para decirle el paso


#Para navegar por ellos, se buscan sus posiciones
x[1]
x[-1] #todo menos el primero
...
write.table(variable a guardar, "fichero.txt")
